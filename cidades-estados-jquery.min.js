...
$.fn.states=function(a){var b="",c={value:!1,text:!1,current:""};returnDefaultOptions(c,a);var d=void 0!=c.value?c.value:"",e=void 0!=c.text?c.text:"",f=void 0!=c.current?c.current.toUpperCase():"";return"SELECT"!=this[0].nodeName?(alert("O retorno precisa ser em um SELECT!\nUse states.JSON() ou states.Array() para outros retornos!"),!1):(STATES_array.forEach(function(a){x1=d?a[1]:a[0],x2=e?a[0]:a[1],xCurrent=f==a[0].toUpperCase()?'selected="selected"':f==a[1].toUpperCase()?'selected="selected"':"",b+="<option "+xCurrent+' value="'+x1+'">'+x2+"</option>"}),void this.html(b))},$.fn.city=function(a){var b="",c={states:STATES_default,current:""};returnDefaultOptions(c,a);var d=void 0!=c.states?c.states.toUpperCase():"",e=void 0!=c.current?c.current.toUpperCase():"";return"SELECT"!=this[0].nodeName?(alert("O retorno precisa ser em um SELECT!\nUse states.JSON() ou states.Array() para outros retornos!"),!1):(STATES_array_city.forEach(function(a){a[0]==d&&a[1].forEach(function(a){xCurrent=e==a.toString().toUpperCase()?'selected="selected"':e==a.toString().toUpperCase()?'selected="selected"':"",b+="<option "+xCurrent+' value="'+a.toString()+'">'+a.toString()+"</option>"})}),void this.html(b))};var states={Array:function(){return STATES_array}},city={Array:function(a){var b=[],c={states:STATES_default};returnDefaultOptions(c,a);var d=void 0!=c.states?c.states.toUpperCase():"";return STATES_array_city.forEach(function(a){a[0]==d&&b.push(a[1])}),b[0]}};
